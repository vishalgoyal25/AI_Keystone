...
| --- | --- | --- | --- |
| [0001](0001-python-as-primary-language.md) | Python as primary language | ✅ Accepted | 2026-08-19 |
| [0002](0002-hexagonal-architecture.md) | Hexagonal architecture with a CI-enforced dependency rule | ✅ Accepted | 2026-08-19 |
| [0003](0003-build-runtime-not-adopt-temporal.md) | Build the execution runtime rather than adopt Temporal | ✅ Accepted | 2026-08-19 |
| [0004](0004-postgres-pgvector-primary-store.md) | PostgreSQL + pgvector as the primary store | ✅ Accepted | 2026-08-19 |
| [0005](0005-aws-with-hard-cost-ceiling.md) | AWS as cloud, under a hard cost ceiling | ✅ Accepted | 2026-08-19 |
| [0006](0006-ecs-fargate-over-eks.md) | ECS Fargate for production; local Kubernetes for learning | ✅ Accepted | 2026-08-19 |
